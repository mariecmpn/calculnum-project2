...
comp_adomain: main_adomain.o fonctions.o adomain.o noyaux.o methodesnum.o donnees.o
	$(CC) -o comp_adomain main_adomain.o fonctions.o adomain.o noyaux.o methodesnum.o donnees.o
